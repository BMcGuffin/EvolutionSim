...
public interface Organism
{
    ...
    /**
     * Checks if the organism's body has decayed away. If so, it can be removed
     * from the map.
     *
     ...
     * it aging. This may include an increase in size, an increase in hunger,
     * etc.
     *
     */
    void grow();
